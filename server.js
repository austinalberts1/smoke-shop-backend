...
console.log("Server started, NRS_TOKEN:", !!NRS_TOKEN);

app.get("/", (req, res) => res.send("Backend is live"));

// --- Direct route registration ---
app.post("/api/nrs/create-payment", async (req, res) => {
  console.log("POST /api/nrs/create-payment hit!", req.body);
  ...
  try {
    const nrspayRes = await fetch(
      "https://gateway.nrspaydashboard.com/api/gateway/hosted-form",
      {
        method: "POST",
